...
const Chats = () => {
    ...
    useEffect(() => {
        ...
        dispatch(setChats([
            ...
            {id: 10,  folder_id: 3, username: 'Человек муравей', user_image: "https://cdn.dribbble.com/users/5534/screenshots/14230133/media/e2f853f8232acad78bf143c32f2f3a04.jpg", online: true,  last_message: 'Последнее сообщение это мм',  count_unread: 20},
    ...
    return (
        <div className={cl.app}>
            ...
            <div className={cl.chat_container}>
                {selectedChatId !== null ? <Chat /> : <div>Пожалуйста, выберите чат чтобы пообщаться с кем-то</div>}
            </div>
        </div>
    );
};
